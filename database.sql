...
CREATE TABLE IF NOT EXISTS `e-lavanderia`.`users` (
  ...
  `address_fav` INT(11) NULL DEFAULT NULL,
  `card_fav` INT(11) NULL DEFAULT NULL,
  `branch_fav` TINYINT(6) NULL DEFAULT NULL,
  `inserted_at` DATETIME NOT NULL,
...
CREATE TABLE IF NOT EXISTS `e-lavanderia`.`payment` (
  ...
  `id_coupon` INT(11) NULL DEFAULT NULL,
  ...
  INDEX `fk_payment_coupon1_idx` (`id_coupon` ASC) VISIBLE,
  CONSTRAINT `fk_payment_users1`
    FOREIGN KEY (`id_client`)
    REFERENCES `e-lavanderia`.`users` (`id_users`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_payment_coupon1`
...
-- -----------------------------------------------------
-- Table `e-lavanderia`.`cheque_use`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `e-lavanderia`.`cheque_use` (
  ...
  `inserted_at` DATETIME NOT NULL,
  `updated_at` DATETIME NOT NULL,
  PRIMARY KEY (`id_cheque_use`),
  INDEX `fk_cheque_use_bank1_idx` (`id_bank` ASC) VISIBLE,
  INDEX `fk_cheque_use_operations1_idx` (`id_operations` ASC) VISIBLE,
  CONSTRAINT `fk_cheque_use_bank1`
    FOREIGN KEY (`id_bank`)
    REFERENCES `e-lavanderia`.`bank` (`id_bank`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_cheque_use_operations1`
    FOREIGN KEY (`id_operations`)
    REFERENCES `e-lavanderia`.`operations` (`id_operations`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8mb4
...
CREATE TABLE IF NOT EXISTS `e-lavanderia`.`operations` (
  ...
  `id_payment` INT(11) NULL,
  `id_cheque_use` INT(11) NOT NULL,
  `id_cc_use` INT(11) NOT NULL,
  `inserted_at` DATETIME NOT NULL,
  `updated_at` DATETIME NOT NULL,
  PRIMARY KEY (`id_operations`, `id_payment`, `id_cheque_use`, `id_cc_use`),
  ...
  CONSTRAINT `fk_operations_cheque_use1`
    ...
    REFERENCES `e-lavanderia`.`cheque_use` (`id_cheque_use`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
...
CREATE TABLE IF NOT EXISTS `e-lavanderia`.`cc_use` (
  ...
  INDEX `fk_cc_use_operations1_idx` (`id_operations` ASC) VISIBLE,
  INDEX `fk_cc_use_card1_idx` (`id_cc` ASC) VISIBLE,
  CONSTRAINT `fk_cc_use_operations1`
    FOREIGN KEY (`id_operations`)
    REFERENCES `e-lavanderia`.`operations` (`id_operations`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
